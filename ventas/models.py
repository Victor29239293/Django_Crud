...
from djangoCrud.utils import valida_cedula,phone_regex,letters_only_validator,numbers_only_validator
...
class Brand(models.Model):
    description = models.CharField('Brand',max_length=100, validators=[letters_only_validator])
...
class Supplier(models.Model):
    name = models.CharField(max_length=100, validators=[letters_only_validator])
    ruc = models.CharField(max_length=13,validators=[valida_cedula])
    address = models.CharField(max_length=200, validators=[letters_only_validator])
...
class Product(models.Model):
    ...
    description = models.CharField('Articulo',max_length=100, validators=[letters_only_validator])
...
class Category(models.Model):
    description = models.CharField(verbose_name='Categoria',max_length=100, validators=[letters_only_validator])
    user = models.ForeignKey(User,on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    state = models.BooleanField('Activo', default = True)
